...
INSERT INTO skill_types (label) VALUES ('Service à la personne et accompagnement'),('Conduite et transport'),('Langues et traduction'),('Restauration et cuisine'),('Prévention et sécurité'),('Assistance médicale et soins'),('Communication et marketing'),('Informatique et numérique'),('Comptabilité et gestion'),('Juridique et administratif'),('Éducation et formation'),('Animation et loisirs'),('Arts et créativité'),('Bricolage et maintenance'),('Événementiel et logistique'),('Collecte de fonds'),('Environnement et jardinage'),('Sport et bien-être'),('Musique et spectacle'),('Accueil et relations publiques');
